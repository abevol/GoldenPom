echo off
set preLink=D:\Data\r2modmanPlus-local\HadesII\profiles\Default\ReturnOfModding\plugins\Abevol-GoldenPom
set preTarget=D:\workspace\games\hades2\ReturnOfModding\plugins\Abevol-GoldenPom\src
